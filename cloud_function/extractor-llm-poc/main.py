# main.py
# Purpose: LLM extractor that reads per-listing JSONL records, fetches the
# original TXT listing, uses Vertex AI to extract structured fields, and writes
# one output JSONL per listing to jsonl_llm/.
...
def _vertex_extract_fields(raw_text: str) -> dict:
    ...
    sys_instr = (
        ...
        "such as gas, diesel, hybrid, or electric; "
        "drive_type should describe the drivetrain if explicitly stated, "
        "such as FWD, RWD, AWD, or 4WD; "
        "title_status should describe the title if explicitly stated, "
        "such as clean, salvage, rebuilt, or lien; "
